...
public class TvVideoFragment extends BrowseFragment implements OnItemViewClickedListener, OnItemViewSelectedListener {
                ...
                public void onChildrenLoaded(@NonNull String parentId,
                    ...
                    switch(id) {
                        case MediaUtils.MEDIA_ID_RECENTLY_ADDED_VIDEO:
                            ...
                            mediaBrowser.unsubscribe(MediaUtils.MEDIA_ID_RECENTLY_ADDED_VIDEO);
                            break;

                        case MediaUtils.MEDIA_ID_RECENTLY_PLAYED_VIDEO:
                            recentlyPlayed.clear();
                            recentlyPlayed.addAll(children);
                            mediaBrowser.unsubscribe(MediaUtils.MEDIA_ID_RECENTLY_PLAYED_VIDEO);
                            break;
            ...
            new MediaBrowserCompat.ConnectionCallback() {
                ...
                public void onConnected() {
                    ...
                    if(rowsAdapter.size() < ROW_COUNT) {
                        mediaBrowser.subscribe(MediaUtils.MEDIA_ID_RECENTLY_ADDED_VIDEO, subscriptionCallback);
                        mediaBrowser.subscribe(MediaUtils.MEDIA_ID_RECENTLY_PLAYED_VIDEO, subscriptionCallback);
                    }
                }
    ...
    private void initialiseInterfaceElements() {
        setTitle(getString(R.string.heading_video));
    ...
    private void startBackgroundTimer() {
        ...
        backgroundTimer.schedule(new TvVideoFragment.UpdateBackgroundTask(), BACKGROUND_UPDATE_DELAY);
    }
